...
app.get("/api/stats", async (req, res) => {
  try {
      ...
      const proCount = await User.countDocuments({ role: "professionnel" });
      const reservationCount = await User.countDocuments({ type: "reservation" }); // Vérifie que la collection existe !
